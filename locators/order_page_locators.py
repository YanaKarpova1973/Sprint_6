...
class OrderPageLocators:
    ...
    CHOSEN_STATION = By.XPATH, "//div[text() = 'Комсомольская']"        # <input tabindex="0" placeholder="* Станция метро" autocomplete="on" class="select-search__input __web-inspector-hide-shortcut__" value="Комсомольская">
    ...
    ORDER_FORMED = By.CLASS_NAME, "Order_ModalHeader__3FDaJ"   # Заказ оформлен
